...
- Self maintenance or customize of a company which introduce this framework may be done. Since PHP itself is easy to understand some simple customize or maintenance of a user company could be done withough SIer which makes application based on this framework. I think this is a win-win relation to me, a SIer and a user company.
