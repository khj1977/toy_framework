...
その後、コードを積み増し、オペレーションを念頭においたフルスタックのWebアプリケーションフレーワークを開発することを目的とすることにした（当然、コードの完成度は高める）。
