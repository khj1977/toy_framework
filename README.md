...
- Author: Hwi Jun KIM ([@pcaffeine77](https://www.instagram.com/pcaffeine77/))
...
This indicates module is sample_app, controller is ScaffoldTwoColTest and action is klist. As reader may understand, actually, this framework deploys HMVC. mod_rewrite for Apache could be used for cool URL. However, author thinks that this way of access to web application is more flexible and thus, this way is used. 
...
- I have to admit Ruby is good language. But not-well designed Ruby code is hard to maintain. However, well-designed PHP code is easy to maintain. Server side biz code is used for long term, author thinks maintenance of code is important.
